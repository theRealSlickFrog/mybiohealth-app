// Priorities — the signal registry + active priorities (Primary / Vitals /
// Structural tabs). Lives under MyStrategy. Mostly hardcoded for v1; data
// wiring comes in a follow-up. (Formerly the "BioSignals" page — renamed when
// the biomarker history charts took over the BioSignals slot.)
